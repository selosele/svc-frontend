...
export const humanRoutes: Routes = [
  // 마이페이지
  {
    ...
    loadComponent: () =>
      import('./human-my-info/human-my-info.component').then(
        (x) => x.HumanMyInfoComponent
      ),
  },
  // 휴가관리 페이지
  {
    ...
    loadComponent: () =>
      import('./human-vacation/human-vacation.component').then(
        (x) => x.HumanVacationComponent
      ),
  },
];
