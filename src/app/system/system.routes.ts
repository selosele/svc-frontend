...
export const systemRoutes: Routes = [
  ...
  // 메뉴관리 페이지
  {
    ...
    loadComponent: () =>
      import('./system-menu/system-menu.component').then(
        (x) => x.SystemMenuComponent
      ),
  },
  // 코드관리 페이지
  {
    ...
    loadComponent: () =>
      import('./system-code/system-code.component').then(
        (x) => x.SystemCodeComponent
      ),
  },
  // 게시판관리 페이지
  {
    ...
    loadComponent: () =>
      import('./system-board/system-board.component').then(
        (x) => x.SystemBoardComponent
      ),
  },
  // 회사정보관리 페이지
  {
    ...
    loadComponent: () =>
      import('./system-company/system-company.component').then(
        (x) => x.SystemCompanyComponent
      ),
  },
];
